...
#.TEMP/PCB13_bcBC3_plasmidPFC8_descSUPERCOILED_genePFC8_SNRPN_REVERSE_Neg_20_0.55_GC.PEAK.local.bed.clust
	...
	makedir("$outFolder/PEAK_TEMP");
	makedir("$outFolder/NOPK_TEMP");
	makedir("$outFolder/PEAK_RCONV");
	makedir("$outFolder/NOPK_RCONV");
	makedir("$outFolder/PEAK_TEMP_RCONV");
	makedir("$outFolder/NOPK_TEMP_RCONV");
	makedir("$outFolder/PEAK_C");
	makedir("$outFolder/NOPK_C");
	makedir("$outFolder/PEAK_TEMP_C");
	makedir("$outFolder/NOPK_TEMP_C");
	makedir("$outFolder/PEAK_RCONV_C");
	makedir("$outFolder/NOPK_RCONV_C");
	makedir("$outFolder/PEAK_TEMP_RCONV_C");
	makedir("$outFolder/NOPK_TEMP_RCONV_C");
	...
	if ($peak eq "PEAK") {
		$output = "$outFolder/PEAK/$outName.gtf" if $strand eq "Pos" and $STRAND eq "+" and $type eq "CH"; #and $gene 
		$output = "$outFolder/PEAK/$outName.gtf" if $strand eq "Neg" and $STRAND eq "-" and $type eq "GH"; #and $gene 
		$output = "$outFolder/PEAK_RCONV/$outName.gtf" if $strand eq "Pos" and $STRAND eq "+" and $type eq "GH"; #and $gene 
		$output = "$outFolder/PEAK_RCONV/$outName.gtf" if $strand eq "Neg" and $STRAND eq "-" and $type eq "CH"; #and $gene 
		$output = "$outFolder/PEAK_TEMP/$outName.gtf" if $strand eq "Pos" and $STRAND eq "-" and $type eq "CH"; #and $gene 
		$output = "$outFolder/PEAK_TEMP/$outName.gtf" if $strand eq "Neg" and $STRAND eq "+" and $type eq "GH"; #and $gene 
		$output = "$outFolder/PEAK_TEMP_RCONV/$outName.gtf" if $strand eq "Pos" and $STRAND eq "-" and $type eq "GH"; #and $gene 
		$output = "$outFolder/PEAK_TEMP_RCONV/$outName.gtf" if $strand eq "Neg" and $STRAND eq "+" and $type eq "CH"; #and $gene 
		$output = "$outFolder/PEAK_C/$outName.gtf" if $strand eq "Pos" and $STRAND eq "+" and $type eq "CG"; #and $gene 
		$output = "$outFolder/PEAK_C/$outName.gtf" if $strand eq "Neg" and $STRAND eq "-" and $type eq "GC"; #and $gene 
		$output = "$outFolder/PEAK_RCONV_C/$outName.gtf" if $strand eq "Pos" and $STRAND eq "+" and $type eq "GC"; #and $gene 
		$output = "$outFolder/PEAK_RCONV_C/$outName.gtf" if $strand eq "Neg" and $STRAND eq "-" and $type eq "CG"; #and $gene 
		$output = "$outFolder/PEAK_TEMP_C/$outName.gtf" if $strand eq "Pos" and $STRAND eq "-" and $type eq "CG"; #and $gene 
		$output = "$outFolder/PEAK_TEMP_C/$outName.gtf" if $strand eq "Neg" and $STRAND eq "+" and $type eq "GC"; #and $gene 
		$output = "$outFolder/PEAK_TEMP_RCONV_C/$outName.gtf" if $strand eq "Pos" and $STRAND eq "-" and $type eq "GC"; #and $gene 
		$output = "$outFolder/PEAK_TEMP_RCONV_C/$outName.gtf" if $strand eq "Neg" and $STRAND eq "+" and $type eq "CG"; #and $gene 
	}
	elsif ($peak eq "NOPK") {
		$output = "$outFolder/NOPK/$outName.gtf" if $strand eq "Pos" and $STRAND eq "+" and $type eq "CH"; #and $gene 
		$output = "$outFolder/NOPK/$outName.gtf" if $strand eq "Neg" and $STRAND eq "-" and $type eq "GH"; #and $gene 
		$output = "$outFolder/NOPK_RCONV/$outName.gtf" if $strand eq "Pos" and $STRAND eq "+" and $type eq "GH"; #and $gene 
		$output = "$outFolder/NOPK_RCONV/$outName.gtf" if $strand eq "Neg" and $STRAND eq "-" and $type eq "CH"; #and $gene 
		$output = "$outFolder/NOPK_TEMP/$outName.gtf" if $strand eq "Pos" and $STRAND eq "-" and $type eq "CH"; #and $gene 
		$output = "$outFolder/NOPK_TEMP/$outName.gtf" if $strand eq "Neg" and $STRAND eq "+" and $type eq "GH"; #and $gene 
		$output = "$outFolder/NOPK_TEMP_RCONV/$outName.gtf" if $strand eq "Pos" and $STRAND eq "-" and $type eq "GH"; #and $gene 
		$output = "$outFolder/NOPK_TEMP_RCONV/$outName.gtf" if $strand eq "Neg" and $STRAND eq "+" and $type eq "CH"; #and $gene 
		$output = "$outFolder/NOPK_C/$outName.gtf" if $strand eq "Pos" and $STRAND eq "+" and $type eq "CG"; #and $gene 
		$output = "$outFolder/NOPK_C/$outName.gtf" if $strand eq "Neg" and $STRAND eq "-" and $type eq "GC"; #and $gene 
		$output = "$outFolder/NOPK_RCONV_C/$outName.gtf" if $strand eq "Pos" and $STRAND eq "+" and $type eq "GC"; #and $gene 
		$output = "$outFolder/NOPK_RCONV_C/$outName.gtf" if $strand eq "Neg" and $STRAND eq "-" and $type eq "CG"; #and $gene 
		$output = "$outFolder/NOPK_TEMP_C/$outName.gtf" if $strand eq "Pos" and $STRAND eq "-" and $type eq "CG"; #and $gene 
		$output = "$outFolder/NOPK_TEMP_C/$outName.gtf" if $strand eq "Neg" and $STRAND eq "+" and $type eq "GC"; #and $gene 
		$output = "$outFolder/NOPK_TEMP_RCONV_C/$outName.gtf" if $strand eq "Pos" and $STRAND eq "-" and $type eq "GC"; #and $gene 
		$output = "$outFolder/NOPK_TEMP_RCONV_C/$outName.gtf" if $strand eq "Neg" and $STRAND eq "+" and $type eq "CG"; #and $gene 

#		$output = "$outFolder/NOPK/$outName.gtf" if $strand eq "Pos" and $STRAND eq "+" and $type eq "CG"; #and $gene 
#		$output = "$outFolder/NOPK/$outName.gtf" if $strand eq "Neg" and $STRAND eq "-" and $type eq "GC"; #and $gene 
#		$output = "$outFolder/NOPK/$outName.gtf" if $strand eq "Pos" and $STRAND eq "+" and $type eq "CH"; #and $gene 
#		$output = "$outFolder/NOPK/$outName.gtf" if $strand eq "Neg" and $STRAND eq "-" and $type eq "GH"; #and $gene 
#		$output = "$outFolder/NOPKNEG/$outName.gtf" if $strand eq "Pos" and $STRAND eq "-" and $type eq "CG"; #and $gene 
#		$output = "$outFolder/NOPKNEG/$outName.gtf" if $strand eq "Neg" and $STRAND eq "+" and $type eq "GC"; #and $gene 
#		$output = "$outFolder/NOPKNEG/$outName.gtf" if $strand eq "Pos" and $STRAND eq "-" and $type eq "CH"; #and $gene 
#		$output = "$outFolder/NOPKNEG/$outName.gtf" if $strand eq "Neg" and $STRAND eq "+" and $type eq "GH"; #and $gene 
	}
	next if $output =~ /ALL/;
