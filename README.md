# footLoop Pipeline v1.6 (sh)

# 0. SYNOPSIS

```
# 1. Install:
git clone https://github.com/srhartono/footLoop_sh/
...
./footClust_sh.pl -n PCB190425_PEAK
...
## 1d. Clustering (footClust_sh.pl)


```
footClust_sh.pl -n <footPeak output directory>
